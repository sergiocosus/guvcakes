    ...
    <center>
        <div id="todo">
            <div class="divTexto" style="margin:20px;">
                ...
                ·         Bajo este concepto, se escogió un ate de guayaba con un sabor que en promedio fuera aceptado como el de la empresa Guayeco, que además se caracteriza por ser económico y así se constituirá el sabor especial del Cup Cake.
                ·         Se requiere ubicar la guayaba en el paladar de los consumidores, con productos en repostería existe la posibilidad de que se convenzan y les guste el producto, hay que hacerlos ver que le hace bien un producto porque tiene poca azúcar, y así les guste la fruta como tal.
                ·         A partir de estos criterios se pretende que la combinación tenga un precio accesible al público.
