...
<html xmlns:fb="http://ogp.me/ns/fb#">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="/css/vista.css"/>
        ...
        <header id="arriba" >
            ...
            <div id="galeria">
                ...
                ?><a href="/Foto/Ver<?php echo generarLink($elementos[$i]->catId,$categorias,$catCant),'/',$elementos[$i]->link;?>">
                        <img src="/imagenes/Foto/<?php echo $elementos[$i]->id; ?>-thumb.<?php echo $elementos[$i]->formato;?>"
    ...
    <div style="text-align:center">
       <nav id="circulos">
           ...
           <a href="https://www.facebook.com/calvillo.com.mx" class="zoom">
