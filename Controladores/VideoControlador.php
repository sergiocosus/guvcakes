...
class VideoControlador extends BaseControlador {
    public  $modelo = "Video";
    public  $modeloCat = "VideoCategoria";
    public  $imageDir='/imagenes/Video/';
    function accionVer(){
        $this->vistaArbol();
    }
    ...
    function actualizaInserta($opcion){
        ...
        if(isset($_POST['titulo']) &&
            ...
            include_once 'Modelos/Video.php';
            if(isset($_FILES['imagen'])){
                include 'library/Image.php';
                if($opcion=="actualizar"){
                    $id=$_POST['id'];
                }else{
                    $id=Video::siguienteId();
                }
                $_POST['formato']=$this->insertarImagen($id,$this->serverPath.'/imagenes','Video');
